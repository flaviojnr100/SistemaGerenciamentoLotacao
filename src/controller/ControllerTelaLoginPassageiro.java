...
public class ControllerTelaLoginPassageiro {
	...
	private void Control() {
		Botoes b = new Botoes();
		tela.getBtnCadastrar().addActionListener(b);
		tela.getBtnSair().addActionListener(b);
		tela.getBtnEsqueci().addActionListener(b);
		tela.getBtnEntrar().addActionListener(b);
		EventoTeclado ev = new EventoTeclado();
		tela.getLoginTxt().addKeyListener(ev);
		tela.getSenhaTxt().addKeyListener(ev);
		tela.getBtnEntrar().addKeyListener(ev);
	}
