...
import controller.ControllerTelaIntegracao;
...
public class App {
	public static void main(String[] args) {
		...
		TelaIntegracao telaIntegracao = new TelaIntegracao();
		telaIntegracao.setVisible(true);
		new ControllerTelaIntegracao(telaIntegracao, loginPassageiro);
	}
}
